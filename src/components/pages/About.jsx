    ...
    <div className="flex flex-col mx-auto w-[1000px] mb-20">
      ...
      <div className="flex justify-between px-4 py-10 ">
        <div className="flex flex-col w-[70%]">
          ...
          <p className="mt-4 font-bold text-[#ebebeb] text-xl">Hello Everybody!...,</p>
          <p className="mt-6 text-xl first-letter:ml-10">This is an API for <span className="text-green-500">Seven Rewayah of Quran Kareem</span>, this made couse i haven't see someone create an API like this, then i am starting to think if i can make it as API for anyone can get it easly. I am named it <span className="text-red-500 font-bold italic">"Quran Rewayah 7"</span>, couse the API provide all of seven rewayah on quran rightly.</p>
          <p className="mt-6 text-xl first-letter:ml-10">So, i am <a className="text-green-500" href="https://github.com/saifuddien">Arief Saifuddien</a> from Jepara, Indonesia. I am a Student for <span className="font-bold text-[#ebebeb] italic">Islamic Studies</span> at International University of Africa Sudan <a href="https://iua.edu.sd" className="text-green-500 ">(IUA)</a>. I am made it actually not alone, but with my friend <a className="text-green-500" href="https://github.com/Toyin5">Muhammad Toyin</a> from Lagos, Nigeria. He is a Student for <span className="font-bold text-[#ebebeb] italic">Computer Science</span> at <a href="https://iua.edu.sd" className="text-green-500 ">(IUA)</a> too.</p>
          <p className="mt-6 font-bold text-[#ebebeb] italic text-xl">Thanks for visitting us!. Give us start, and support us for anything...</p>
        </div>
        <div className="flex flex-col ml-10">
          <h1 className="font-semibold text-2xl mb-2 pb-3 border-b border-slate-400 text-white" >API Made With :</h1>
          <p className="mt-4 text-md" ><i className="mr-2 text-red-500 fab fa-html5"></i> HTML</p>
          <p className="mt-2 text-md" ><i className="mr-2 text-blue-800 fab fa-css3-alt"></i> CSS</p>
          <p className="mt-2 text-md" ><i className="mr-2 text-blue-400 fab fa-css3-alt"></i> Tailwind</p>
          <p className="mt-2 text-md" ><i className="mr-2 text-yellow-500 fab fa-js-square"></i> Javascript</p>
          <p className="mt-2 text-md" ><i className="mr-2 text-green-500 fab fa-node-js"></i> Node JS</p>
          <p className="mt-2 text-md" ><i className="mr-2 text-white fab fa-node-js"></i> Express JS</p>
          <p className="mt-2 text-md"><i className="mr-2 text-blue-500 fab fa-react"></i> React JS</p>
        </div>
      </div>

      <div className="px-4 my-20">
        <h1 className="font-semibold text-center text-3xl mb-5 pb-5 border-b border-slate-400 text-white">API Members :</h1>
      ...
      <div className="px-4 mt-20">
        <h1 className="font-semibold text-center text-3xl mb-5 pb-5 border-b border-slate-400 text-white">Contact Us :</h1>

        <div className="flex justify-between w-[100%] py-10 px-5">
          <form className="w-[60%]">
            {
            ...
            <input required type="text" placeholder="Input Your Subject..." onChange={(e) => setSubject(e.target.value)} className="subject mt-2 bg-transparent text-white py-2 pl-3 rounded-xl text-md  border outline-none border-slate-400 w-[100%]" />
            ...
            {
              (Commited == false) ? <button disabled className="cursor-not-allowed mt-12 py-2 pl-3 rounded-full text-lg bg-[#3c217c] font-bold w-[100%]" >Send An Email</button> : <p className="cursor-pointer text-center mt-12 bg-[#3700b3] text-white py-2 pl-3 rounded-full text-lg hover:bg-[#3c217c] font-bold w-[100%]" onClick={() => sendEmail()}>Send An Email</p>
            }
          </form>

          <div className="flex flex-col justify-around items-center bg-slate-800 opacity-70 rounded-lg px-12 ml-5">
