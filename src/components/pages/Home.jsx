...
function Home() {
  return (
    <div className="flex flex-col w-[100%] lg:w-[1000px] mx-auto mb-20 p-4 font-[tajawal]">
      ...
      <p className="font-bold text-lg sm:text-2xl md:text-3xl text-center mb-20"><i>"Once Login, Get Token, Do Anything..."</i></p>
      <hr />
      ...
      <div className="flex flex-col sm:flex-row items-center justify-around pt-20">
        <div className="flex items-center my-8 -ml-4 sm:ml-0 sm:text-sm md:text-base">
          <img src="/images/arief.jpg" className="border-2 border-[#ebebeb] w-36 h-36 sm:h-28 sm:w-28 md:h-36 md:w-36 rounded-full mr-4" alt="Arief Photo" />
        ...
        <div className="flex items-center my-8 sm:text-sm md:text-base">
          <img src="/images/toyin.jpg" className="border-2 border-[#ebebeb] w-36 h-36 sm:h-28 sm:w-28 md:h-36 md:w-36 rounded-full mr-4" alt="Toyin Photo" />
          <div className="flex flex-col">
